...
export const Icons = {
  ...
  skill: (p) => <Icon {...p}><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H11v16H6.5A2.5 2.5 0 0 0 4 21z"/><path d="M20 5.5A2.5 2.5 0 0 0 17.5 3H13v16h4.5A2.5 2.5 0 0 1 20 21z"/><path d="m16.7 5.1.65 1.75 1.75.65-1.75.65-.65 1.75-.65-1.75-1.75-.65 1.75-.65z"/></Icon>,
  mcp: (p) => <Icon {...p}><rect x="4" y="4" width="16" height="6" rx="2"/><rect x="4" y="14" width="16" height="6" rx="2"/><path d="M8 7h.01M8 17h.01M12 10v4M16 10v4"/><circle cx="12" cy="12" r="1.4" fill="currentColor" stroke="none"/></Icon>,
