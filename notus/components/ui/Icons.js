...
export const Icons = {
  ...
  fileText: (p) => <Icon {...p}><path d="M14 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><path d="M14 3v6h6M8 13h8M8 17h5"/></Icon>,
  fileEdit: (p) => <Icon {...p}><path d="M14 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h5"/><path d="M14 3v6h6M13 18h-4v-4l6.5-6.5a2.1 2.1 0 0 1 3 3z"/></Icon>,
  ...
  paperclip: (p) => <Icon {...p}><path d="M21.4 11.2 12 20.6a6 6 0 1 1-8.5-8.5l9.2-9.2a4 4 0 0 1 5.7 5.7l-9.2 9.2a2 2 0 1 1-2.8-2.8l8.5-8.5"/></Icon>,
  ...
  messagePlus: (p) => <Icon {...p}><path d="M20 11.5a7.5 7.5 0 0 1-8 7.5 8.3 8.3 0 0 1-3.2-.7L4 20l1.6-4.1A7.2 7.2 0 0 1 4.5 12a7.5 7.5 0 0 1 15-.5z"/><path d="M12 8.5v6M9 11.5h6"/></Icon>,
  messageQuestion: (p) => <Icon {...p}><path d="M20 11.5a7.5 7.5 0 0 1-8 7.5 8.3 8.3 0 0 1-3.2-.7L4 20l1.6-4.1A7.2 7.2 0 0 1 4.5 12a7.5 7.5 0 0 1 15-.5z"/><path d="M9.8 9.8a2.3 2.3 0 1 1 3.8 1.7c-.9.7-1.6 1-1.6 2M12 16h.01"/></Icon>,
  ...
  circleX: (p) => <Icon {...p}><circle cx="12" cy="12" r="9"/><path d="m9 9 6 6M15 9l-6 6"/></Icon>,
  ...
  lock: (p) => <Icon {...p}><rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V8a4 4 0 1 1 8 0v3"/></Icon>,
